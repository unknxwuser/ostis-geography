...
class GetKindergartensByDistrictAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
                self.keynodes['action_get_kindergartens_by_district'],
                self.main_node,
            ...
            try:
                ...
                districtIterator = self.ctx.Iterator5(
                    ScType.Unknown,
                    ScType.EdgeDCommon,
                    node,
                    ScType.EdgeAccessConstPosPerm,
                ...
                while districtIterator.Next():
                    for i in range(5):
                        self.add_nodes_to_answer(answerNode, [districtIterator.Get(i)])
